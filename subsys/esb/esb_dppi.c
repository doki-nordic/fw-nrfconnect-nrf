...
#else
    nrf_radio_publish_set(NRF_RADIO, NRF_RADIO_EVENT_READY, esb_dbg_dppi_gpio_ready);
    nrf_radio_publish_set(NRF_RADIO, ESB_RADIO_EVENT_END,   esb_dbg_dppi_gpio_end);
#endif
